...
<div class="wrapper">
 ...
 <? $this->getPart('inc/sidebar-admin')?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?__('Starter_Page')?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <footer class="main-footer">
    ...
    <p><a href="https://github.com/Sara894/Kursach/" target="_blank"><img src="http://qrcoder.ru/code/?https%3A%2F%2Fgithub.com%2FSara894%2FKursach%2F&4&0" width="148" height="148" border="0" title="QR код"><?__('help_dev')?></a></p>
    <!-- Default to the left -->
